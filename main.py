...
# вложеный селектор
# вендерные прешекты в css для подстройки браузеров !!!! вестка под мобильный телефон там большой палец  несколько активных элементами
# растоянии делают тоже больше
# bootstrape vu port
# CDN content delivery nrtwork
# bootstrap
#  - стили- связка
# сетка bootstrap всё разделено на 12 колонок(N/12)
# dif тег блочный элемент  который занимает всю ширину страницы два заголовка не может быть на одной строке
# строчный элемент это элемент который занимает свою ширину  все заварачивается в контейнер <div class ="conteiner"> </div> это класс контейнер
# <div class= "row"><div class=col-12 col-sm-9 col-md-7 col-lg-5 col-xl-3> блок</div> </div>адаптируется под ширину экрана